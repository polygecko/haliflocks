      ...
      <div className={styles.container}>
        ...
        <section className={styles.defSection}>
          ...
          <div className={styles.defEntry}>
            ...
            <div className={styles.defSep} />
            <div className={styles.defBody}>
              <p>Not everyone identifies as being from Halifax or a Haligonian. Halifax Regional Municipality is made up of a diverse range of communities, each with its own history, associations, and assets. HaliFlocks seeks to respectfully explore the many distinct communities that make up the area now called Halifax.</p>
